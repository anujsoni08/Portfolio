  ...
  return (
    <div className="about-div d-flex">
      ...
      <div className="card-body flex-2">
        ...
        <p className="card-text">
          I believe learning is a process that never stops, even though you may
          become old enough there are things that you can still learn.A simple
          nature and simple choices, dream of the stars with feet on the ground.
          This is what I think and with the same in my heart, I am marching
          towards my goal.
        </p>
